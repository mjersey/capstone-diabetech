document.addEventListener("DOMContentLoaded", () => {
    ...
    // Form submission with actual backend request and loading animation
    form.addEventListener("submit", (e) => {
      ...
      if (isValid) {
        ...
        fetch("/api/sign-in", {
          ...
          .then((data) => {
            if (data.success) {
              // Redirect on successful login using Flask route
    ...
    document.getElementById("signUpLink").addEventListener("click", (e) => {
      e.preventDefault()
      window.location.href = "/" // Changed from 'sign-up.html' to Flask route
    })
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        // Form submission with loading page redirect
        form.addEventListener("submit", (e) => {
          e.preventDefault()
